    ...
    capabilities: [
        {
            ...
            'goog:chromeOptions': {
                args: [
                    ...
                    // user agents with this specific format are whitelisted in cloudflare so e2e tests don't get rate limited
                ...
                prefs: {
                    profile: {
                        // Disabling images to load to speed up the test execution
                        default_content_setting_values: { images: 2 },
                        managed_default_content_settings: { notifications: 2 },
                    },
                },
            },
        },
